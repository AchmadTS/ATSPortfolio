...
- (STRICT) ALWAYS format URLs and emails as clean, clickable Markdown links. For contacts, use the format: [Name](URL) or [Email](mailto:...). Do NOT display the URL/email address itself as text if it makes the line messy. Example: [LinkedIn](https://...).
...
Projects: 
- TofuBase (Ongoing): Java Swing/MySQL desktop app for tofu factory. Role auth, raw material/supplier management. Link: [GitHub](https://github.com/AchmadTS/TofuBase)
- Neskar Insight (Sep 2024): SMKN 1 Karawang web. Link: [Neskar Insight](https://smkn1karawang.sch.id/)
