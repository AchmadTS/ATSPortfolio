...
- Focus ONLY on Achmad's profile, education, experience, skills, projects, certificates, contacts.
...
DATA:
Profile: Achmad Tirto Sudiro (ATS Portfolio), Student in Karawang, ID. Focus: Web Backend Dev & Software Eng. Fresh grad SMKN 1 Karawang, now at Telkom Univ. Fast Learner, Problem Solver, Team Work, Detail Master.
...
Projects: 
- TofuBase (Ongoing): Java Swing/MySQL desktop app for tofu factory. Role auth, raw material/supplier management. [github.com/AchmadTS/TofuBase](https://github.com/AchmadTS/TofuBase)
- Neskar Insight (Sep 2024): SMKN 1 Karawang web. [smkn1karawang.sch.id](https://smkn1karawang.sch.id/)
- ATZuperr-Cashier (Feb 2025): [github.com/AchmadTS/ATZuperr-Cashier-FrontEnd](https://github.com/Achmadts/ATZuperr-Cashier-FrontEnd)
...
Contact: Email: [achmadtirtosudirosudiro@gmail.com](mailto:achmadtirtosudirosudiro@gmail.com), Phone: +6285878288920, LinkedIn: [Achmad Tirto Sudiro](https://id.linkedin.com/in/achmad-tirto-sudiro-368aa6304), GitHub: [Achmadts](https://github.com/Achmadts/), IG: [@ats090906](https://www.instagram.com/ats090906/).`,
};
