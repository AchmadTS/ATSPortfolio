  ...
  en: {
    exact: {
      ...
      "What kind of developer role is he looking for?": 
        "I am currently looking for opportunities as a **Web Backend Developer** or **Fullstack Developer**. I thrive in roles that challenge my logic and problem-solving skills! ✨",
      
      "What technologies do you use?": 
        "I use a modern tech stack to build scalable systems:\n- **Languages:** PHP, JavaScript, TypeScript, Java.\n- **Frameworks:** Laravel, React, TailwindCSS.\n- **Tools:** MySQL, Figma, Git.",
    },
    topics: {
      skills: "My expertise is focused on **Web Backend Development**. Core stack includes Laravel, PHP, React, MySQL, and Node.js. 🚀",
      projects: "I have worked on several projects, including TofuBase, Neskar Insight, and ATZuperr-Cashier. Check them out on my GitHub!",
      education: "I am currently a Computer Science student at Telkom University, and a graduate of SMKN 1 Karawang (Software Engineering).",
      role: "I am targeting roles as a **Web Backend Developer** or **Fullstack Developer**.",
    },
    greeting: "Hello! I am Achmad's AI assistant. How can I help you today? Do you want to know about his skills, projects, or education? 😊",
  },

  // === JAWABAN UNTUK BAHASA INDONESIA ===
  id: {
    exact: {},
    topics: {
      skills: 
    ...
    greeting: "Halo! Saya asisten AI Achmad. Ada yang bisa saya bantu? Mau tanya soal skill, project, atau pendidikan Achmad? 😊",
  },
};

export default suggestionAnswers;